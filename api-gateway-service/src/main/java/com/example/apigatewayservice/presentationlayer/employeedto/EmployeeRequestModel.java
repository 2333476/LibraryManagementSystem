...
public class EmployeeRequestModel {
    ...
    // ✅ Builder pattern à la main (équivalent de @Builder)
    public static class Builder {
        ...
        public EmployeeRequestModel build() {
            return new EmployeeRequestModel(
                    firstName, lastName, emailAddress, phoneNumber,
                    salary, commissionRate, department,
                    streetAddress, city, province, country, postalCode
            );
        }
    }

    // ✅ Méthode statique pour initier le builder
    public static Builder builder() {
        return new Builder();
    }

    // ✅ Getters manuels (puisqu’il n’y a pas @Getter)
